...
def start(update: Update, context: CallbackContext):
    ...
    update.message.reply_text("Rules.... Words will be shown and you will be asked to pick the correct one from the options", reply_markup=reply_markup)
...
def seven(update: Update, context: CallbackContext) -> str:
    ...
    keyboard = [
        [
            InlineKeyboardButton("Play", callback_data=str(ZERO2)),
            InlineKeyboardButton("Hug", callback_data=str(ZERO3)),
        ],  
    
        [     
            InlineKeyboardButton("Joy", callback_data=str(EIGHT)),
...
def eight(update: Update, context: CallbackContext) -> str:
    ...
    keyboard = [
        [
            InlineKeyboardButton("192 306", callback_data=str(ZERO2)),
            InlineKeyboardButton("267 495", callback_data=str(ZERO3)),
        ],  
...
def last(update: Update, context: CallbackContext) -> int:
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    query.edit_message_text(
        text="Congratulations, You Won! 🥳🥳... But you get nothing 😅... Want to play again? ", reply_markup=reply_markup
    )
    return SECOND 
